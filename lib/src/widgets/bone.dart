...
/// A widget that represents a bone of the loading placeholder effect
...
class _TextBone extends Bone {
  ...
  Widget build(BuildContext context) {
    ...
    if (uniRadius == null && effectiveBorderRadius == null) {
      final textBorder = Shimmerize.of(context).config.textBorderRadius;
...
/// A widget that paints a [BoxDecoration] into a canvas with [ManualShimmerizePaintingContext].
...
class BoneRenderObject extends RenderProxyBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final paint =
        (context is ShimmerizePaintingContext) ? context.shaderPaint : Paint()
          ..color = Colors.grey;
